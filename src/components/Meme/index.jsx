...
const Meme = ({ meme, setMeme }) => {
  ...
  let url = `https://api.imgflip.com/caption_image?template_id=${id}&username=Medj_1&password=Azerty12345`;
    ...
    <div className="container">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="Inputs">
            ...
            <button type="submit"  className="Button"onClick={() => downloadImage(meme.url)}>
              Download Meme
            </button>
          </div>
        </form>
